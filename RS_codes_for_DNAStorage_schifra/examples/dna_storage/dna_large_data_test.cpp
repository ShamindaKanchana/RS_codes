/*
 * Block-wise processing of large DNA sequences using Schifra Reed-Solomon
...
// Function to process the entire DNA sequence
...
void run_tests() {
    std::cout << "=== Schifra DNA Storage - Block-wise Processing Test ===\n\n";
    ...
    std::string large_sequence = generate_random_dna(1000);
    ...
    std::vector<TestCase> test_cases = {
        ...
        {"Large sequence (1000 chars)", large_sequence, 1},
